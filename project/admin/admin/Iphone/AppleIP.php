            ...
            <div class="showinfo">
                ...
                <center>       <table border="1">
                    ...
                    <?php 
                        ...
                        $select_post = "SELECT * FROM Apple order by 1 DESC";
                    ...
                    <tr>
                        ...
                        <td><a href="delete_apple.php?del=<?php echo $post_id; ?>">Delete</a></td>
                        <td><a href="edit_apple.php?edit=<?php echo $post_id; ?>">Edit</a></td>
                    </tr>
