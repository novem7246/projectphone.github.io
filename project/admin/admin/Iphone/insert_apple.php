<?php 
       ...
       if (isset($_POST['submit'])) {  
        ...
        $insert_query = "INSERT INTO Apple (post_title, post_date, post_price, post_image, post_keywords, post_url) 
   ...
   /*     if(empty($post_title) || empty($post_price)){
  echo "<script>alert('Title and price fields cannot be empty');</script>";
  exit();
}
...
if(!mysqli_stmt_prepare($stmt, $insert_query)){
    ...
    mysqli_stmt_bind_param($stmt, "ssssss", $post_title, $post_date, $post_price, $post_image, $post_keywords, $post_url);
    mysqli_stmt_execute($stmt);
}
//header("location: https://unacademic-night.000webhostapp.com/admin/index.php");
*/
}
?>
    ...
    <section class="content">
        <div class="content__grid">
            ...
            <div class="showinfo">
                ...
                <form method="post" action="insert_apple.php" enctype="multipart/form-data">

                <table width="100%" align="center" border="1">
                    
                    <tr>
                        <td align="center" colspan="6">
                        <h1>เพิ่มข้อมูล iphone</h1>
                    </tr>
