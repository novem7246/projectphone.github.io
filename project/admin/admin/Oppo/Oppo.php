            ...
            <div class="showinfo">
                ...
                <center>       <table border="1">
                    ...
                    <?php 
                        ...
                        $select_post = "SELECT * FROM Oppo order by 1 DESC";
                    ...
                    <tr>
                        ...
                        <td><a href="delete_oppo.php?del=<?php echo $post_id; ?>">Delete</a></td>
                        <td><a href="edit_oppo.php?edit=<?php echo $post_id; ?>">Edit</a></td>
                    </tr>
