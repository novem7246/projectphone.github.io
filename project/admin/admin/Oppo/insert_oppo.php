<?php 
        ...
        $insert_query = "INSERT INTO Oppo (post_title, post_date, post_price, post_image, post_keywords, post_url) 
    ...
    <section class="content">
        <div class="content__grid">
            ...
            <div class="showinfo">
                ...
                <form method="post" action="insert_oppo.php" enctype="multipart/form-data">
