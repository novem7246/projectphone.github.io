...
if(isset($_GET['edit'])){
    $edit_id = $_GET['edit'];
    $select_query = "SELECT * FROM Oppo WHERE post_id = '$edit_id'";
...
if(isset($_POST['update'])){
    ...
    $update_query = "UPDATE Oppo SET post_title = '$post_title', post_price = '$post_price',
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <table align="center" width="700" border="2">
            <tr>
                <td colspan="7" align="center"><h2>แก้ไขข้อมูล Oppo</h2></td>
            </tr>
            <tr>
